yes = "y"; no = "n"; answer = String(prompt("Do you like javascript? ")); // Sets all variables and aks them for input
firstChar = answer.charAt(0) // Takes first character of their input so if they use the words Yes or No it will still work
