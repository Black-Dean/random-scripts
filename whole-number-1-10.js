num = parseInt(prompt("Please enter a number between 1 and 10")) // Parse int will make it so the user cannot enter decimal numbers and will take everything they entered up to the decimal, this ensures that they have entered a full number rather than a decimal number.
if (isNaN(num)) {
